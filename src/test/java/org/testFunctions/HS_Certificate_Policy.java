...
public class HS_Certificate_Policy extends BaseClass {

	public static String HS_Policy_Number = null;
	...
	public void tc001(String S_No, String Policy_Type, String Types_of_Policy, String Business_Source,
		...
		HS_Master_Policy HSO = new HS_Master_Policy();
		...
		if (HSO.HS_Policy_Number == null) {
			...
			webDriverWait(ExpectedConditions.elementToBeClickable(uwp.Open_Policy_Number()));
			uwp.Open_Policy_Number().sendKeys(HSO.HS_Policy_Number);
			javaScribtClick(uwp.Open_Policy_number_click());
		}
		...
		webDriverWait(ExpectedConditions.elementToBeClickable(cus.Certificate_Quote()));
		HS_Quotation = cus.Certificate_Quote().getText();
...
//		Enter Processor Name
		...
		cus.Processor_Name_Field().clear();
