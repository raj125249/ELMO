...
public class Policy_Cancellation_Endorsement extends BaseClass {
	@Test(dataProvider = "Policy_Cancellation")
	public void tc_001(String S_No, String Search_Policy, String Policy_Number, String Type_of_Policy,
			...
			String Insured_Billing_Account, String Run_Flag) throws AWTException, InterruptedException, ClassNotFoundException, IOException {
