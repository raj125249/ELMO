...
public class Endors_Page extends BaseClass {
	...
	public void tc_001(String S_No, String Policy_Type, String Types_of_Policy, String Business_Source,
			...
			String Add_Ins_Relation, String Add_Ins_Address, String Surveyor, String Add_Surveyor_Query,
			String Add_Surveyor_ID, String Surveyor_Risk, String Survey_Doc_type, String Coinsurer_Name_Query,
			String Coinsurer_ID, String Coinsurer_Share, String Doc_type, String Special_Tty, String RI_Ceding_Basic,
		...
		if (Policy_Endorsements.equals("Yes")) {
			...
			if (pol.Policy_Number == null) {
				String Endorse_Policy = "SELECT * FROM (SELECT TPI_POLICY_NO FROM T_POL_INFO WHERE TPI_STATUS = 'A' AND NOT EXISTS (SELECT 1 FROM Q_POL_INFO WHERE \r\n"
						...
						+ "OR TPI_END_TYPE IS NULL) and (tpi_prod_code in(0102,0202,0302,0502)) ORDER BY DBMS_RANDOM.VALUE) WHERE ROWNUM = '1'";
...
//			Risk information page
				if (Add_Risk.equals("Yes")) {
					...
					if (Policytype.equals("Erection All Risks")
							|| Policytype.equals("Contractors All Risks Insurance")) {
...
//						Click the risk edit icon to enter the Inward SI and Premium
				...
				if (B_Source.equals("Direct with Elmo Leader") || B_Source.equals("Direct with Elmo Follower")
						...
						|| B_Source.equals("Salesman with Elmo Leader")
						|| B_Source.equals("Introducers with Elmo Leader")
...
//				Get Net To Customer
				...
				pol.Net_To_Customer = ra.Net_to_Customer().getText();
				System.out.println("Net to Customer: " + pol.Net_To_Customer);
...
//						Enter Amount
						...
						ra.amount_Field().sendKeys(pol.Net_To_Customer);
...
//				Enter Quote Number
				...
				try {
					...
					Endor_Pol = EIP.get_Policy().getText();
...
//Change in Policy period.
			if (Change_Policy_Endors.equals("Yes")) {
...
//						Save the details
							...
							webDriverWait(
									ExpectedConditions.elementToBeClickable(EIP.approve_Non_Financial_Endorsement()));
							javaScribtClick(EIP.approve_Non_Financial_Endorsement());
							...
							try {
								...
								if (ra.Quotation_SI_WFMSG().isDisplayed()) {
									...
									rb.delay(3000);
									webDriverWait(
											ExpectedConditions.elementToBeClickable(WFA.Clm_Myactionstab_Search()));
									WFA.Clm_Myactionstab_Search().sendKeys(SI_WF_RefNo);

									webDriverWait(
											ExpectedConditions.elementToBeClickable(WFA.Clm_Approver_Viewoption()));
									WFA.Clm_Approver_Viewoption().click();
									...
									webDriverWait(
											ExpectedConditions.elementToBeClickable(GSP.Search_Policy_Dropdown()));
									selectByVisibleText(GSP.Search_Policy_Dropdown(), "Policy No");
...
//ends here change in Policy period				
			}

//extension policy period
			if (Extension_Policy_Endors.equals("Yes")) {
...
// Reduction starts here
			if (Reduction_Policy_Endors.equals("Yes")) {
...
//	    	click proceed
					...
					StringSelection ss11 = new StringSelection(
							System.getProperty("user.dir") + "\\Files\\Certificate.xls");
...
//Discounts and Loadings starts here
...
//Policy Cancellation starts here

			if (Policy_Cancellation_Endors.equals("Yes")) {
...
//Cancellation Ends here
			...
			if (Policy_Reinstatement_Endors.equals("Yes")) {
...
//					Enter Amount
						...
						EIP.amount_Field().sendKeys(pol.Net_To_Customer);
					} else if (Cash_Type.equals("CASH")) {
