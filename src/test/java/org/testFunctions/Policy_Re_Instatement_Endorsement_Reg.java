...
public class Policy_Re_Instatement_Endorsement_Reg extends BaseClass {

	@Test(dataProvider = "Policy_Re_Instatement_Reg")
	public void tc_001(String S_No, String Search_Policy, String Policy_Number, String Type_of_Policy,
			...
			String Insured_Billing_Account, String Cash_Type, String Cheque_No, String Bank_Name, String Account_Number, String Run_Flag)
...
//		Approve Endorsement
		...
		scrollDownJavaSc(EIP.get_Policy());
