...
public class Deletion_of_Risk_Endorsement_Reg extends BaseClass {

	@Test(dataProvider = "Deletion_of_Risk_Reg")
	public void tc_001(String S_No, String Search_Policy, String Policy_Number, String Type_of_Policy,
			...
			String Insured_Billing_Account, String Run_Flag) throws InterruptedException, IOException {
...
//		Get Product
		...
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Endorsement_Type()));
		String endorsement_Type = object.get_Endorsement_Type().getText();
...
//		Get Policy Number 
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Policy_Number()));
		String policy_No = object.get_Policy_Number().getText();
...
//		Get Customer name
		webDriverWait(ExpectedConditions.visibilityOf(object.customer_Name()));
		String customer_Name = object.customer_Name().getText();
		String customer = customer_Name.replace(" - ", "-");
		System.out.println("Customer name is: " + customer);

//		Enter Remarks
		webDriverWait(ExpectedConditions.visibilityOf(object.remarks_Field()));
		object.remarks_Field().sendKeys(Remarks);
...
//		Delete Risk
		webDriverWait(ExpectedConditions.elementToBeClickable(object.delete_Risk()));
		object.delete_Risk().click();

		webDriverWait(ExpectedConditions.elementToBeClickable(object.delete_Risk_Confirm_Button()));
		object.delete_Risk_Confirm_Button().click();

		Thread.sleep(5000);

//		Get Deleted SMI Premium
		webDriverWait(ExpectedConditions.visibilityOf(object.deleted_SMI_Premium()));
		scrollDownJavaSc(object.deleted_SMI_Premium());
		String premium = object.deleted_SMI_Premium().getText();

//		Click Proceed Button
		webDriverWait(ExpectedConditions.elementToBeClickable(object.proceed_Button()));
		object.proceed_Button().click(); // Puneeth
		try {
			webDriverWait(ExpectedConditions.elementToBeClickable(object.ok_Button()));
			object.ok_Button().click();
		} catch (Exception e) {
...
//		get Policy Fess 
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Policy_Fees()));
		String policy_Fees = object.get_Policy_Fees().getText();
...
//		Click Proceed Button
		...
		javaScribtClick(object.proceed_Button());
		Thread.sleep(3000);
//		Get Gross_Premium
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Gross_Premium()));
		String gross_premium = object.get_Gross_Premium().getText();
...
//		Get Discount
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Discount()));
		String discount = object.get_Discount().getText();
		System.out.println(discount);
		double Discount_Amount = string_To_double_Convert(discount);

//		Get Loading
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Loading()));
		scrollDownJavaSc(object.get_Charge());
		String loading = object.get_Loading().getText();
		System.out.println(loading);
		double Loading_Amount = string_To_double_Convert(loading);

//		Get Fees
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Charge()));
		String Fees = object.get_Charge().getText();
		double Fees_Amount = string_To_double_Convert(Fees);

//		Get Policy Tax
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Policy_Tax_Text()));
		String policy_Tax_percentage = object.get_Policy_Tax_Text().getText();
...
//		Get Policy Tax Amount
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Policy_Tax_amount()));
		String Policy_Tax_Amount = object.get_Policy_Tax_amount().getText();
...
//		Get Inward Commission
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Inward_Commission_amount()));
		String Inward_Commission = object.get_Inward_Commission_amount().getText();
		double Inward_Commission_Amount = string_To_double_Convert(Inward_Commission);

//		get Inward Commission Percentage
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Inward_Commission_Tax_Text()));
		String get_Inward_Commission_Tax_Text = object.get_Inward_Commission_Tax_Text().getText();
...
//		Get Inward Commission Amount
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Inward_Commission_Tax_Amount()));
		String Inward_Commission_Tax_Amount = object.get_Inward_Commission_Tax_Amount().getText();
...
//		Get Net Premium
		webDriverWait(ExpectedConditions.visibilityOf(object.get_Net_Premium()));
		String Net_Premium_Amount = object.get_Net_Premium().getText();
...
//		Select Mode of Pay
		webDriverWait(ExpectedConditions.visibilityOf(object.mode_of_Pay_Dropdown()));
		selectByVisibleText(object.mode_of_Pay_Dropdown(), Mode_Of_Pay);

		if (Mode_Of_Pay.equals("Debit")) {
			webDriverWait(ExpectedConditions.visibilityOf(object.Insured_Billing_Account()));
			try {
				selectByVisibleText(object.Insured_Billing_Account(), customer);
			} catch (Exception e) {
				selectByIndex(object.Insured_Billing_Account(), 3);
			}

		} else if (Mode_Of_Pay.equals("SEPA")) {
			
			webDriverWait(ExpectedConditions.elementToBeClickable(object.SEPA_Acc_Number()));
			object.SEPA_Acc_Number().sendKeys("65468654658");
			
			webDriverWait(ExpectedConditions.elementToBeClickable(object.SEPA_Swift_Code()));
			object.SEPA_Swift_Code().sendKeys("JHFHGFI36879856");
			
			webDriverWait(ExpectedConditions.elementToBeClickable(object.SEPA_IBAN_No()));
			object.SEPA_IBAN_No().sendKeys("GCI657658765469");
			
			webDriverWait(ExpectedConditions.elementToBeClickable(object.SEPA_Bank_Name()));
			selectByIndex(object.SEPA_Bank_Name(), 2);			
			
			webDriverWait(ExpectedConditions.visibilityOf(object.BIC_Code()));
			object.BIC_Code().sendKeys(Account_Number);
		}
		Thread.sleep(5000);
//		Approve Endorsement
		webDriverWait(ExpectedConditions.elementToBeClickable(object.approve_Endorsement_Button()));
		javaScribtClick(object.approve_Endorsement_Button());
		// object.approve_Endorsement_Button().click();

		webDriverWait(ExpectedConditions.visibilityOf(object.get_Policy()));
		String policyNumber = object.get_Policy().getText();
		System.out.println("Policy Number is: " + policy_Number);
...
//		Customer Name Verification
		String customerName = object.customer_Name().getText();
		System.out.println("Customer Name is: " + customerName);

		webDriverWait(ExpectedConditions.elementToBeClickable(object.Close_Button()));
		object.Close_Button().click();
