...
public class Login_Claims extends BaseClass {
	
	public static String Loginuser;
	public static String Loginuser_password;
	public static String Login_User_Name;

	@Test(dataProvider = "Login_Claims")
	
	public void tc001(String S_No, String UserId, String Password_Query, String Password_Query_Column, String Run_Flag) throws ClassNotFoundException, IOException {
