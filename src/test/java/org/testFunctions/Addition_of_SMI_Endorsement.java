...
public class Addition_of_SMI_Endorsement extends BaseClass {

	@Test(dataProvider = "Addition_of_SMI_Endorsement")
	public void tc_001(String S_No, String Search_Policy, String Policy_Query, String Policy_ID, String Type_of_Policy,
			String Insured_Name, String Endorsement_Type, String Remarks, String Sum_Insured_Amount,
			String Sum_Insured_Rate, String Mode_Of_Pay, String Cash_Type, String Cheque_No, String Bank_Name,
			String Account_Number, String Insured_Billing_Account, String Run_Flag)
...
//		Issue_Policy_Risk_Information_Page objects = new Issue_Policy_Risk_Information_Page();
		...
		GSP.Policy_Number_Field().sendKeys(get_DB_Data(Policy_Query, Policy_ID));
...
//		}
		...
		String premium_Amount = getAtrributeValue(ris.SMI_Premium_Field(), "title");
...
//		EIP.special_Tty_No_Option().click();
		...
		// if
		//// (gross_premium.contains(Issue_Policy_Risk_Information.annual_Sum_Insured_Premium))
		//// {
		// Assert.assertEquals(gross_premium,
		//// Issue_Policy_Risk_Information.annual_Sum_Insured_Premium);
		...
		if (Mode_Of_Pay.equals("Cash")) {
			...
			if (Cash_Type.equals("CHEQUE")) {
				...
				EIP.account_Number_Field().sendKeys(Account_Number);
