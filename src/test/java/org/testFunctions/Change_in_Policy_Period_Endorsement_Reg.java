...
public class Change_in_Policy_Period_Endorsement_Reg extends BaseClass {

	@Test(dataProvider = "Change_in_Policy_Period_Reg")
	public void tc_001(String S_No, String Search_Policy, String Policy_Number, String Type_of_Policy,
			String Insured_Name, String Endorsement_Type, String Effective_From_Date, String Remarks, String Run_Flag)
		...
		LocalDate nextDate = currentDate.plusDays(20);

		// Format the next date to the desired format
		String formattedNextDate = nextDate.format(formatter);
		GSP.effective_From_Date().sendKeys(Effective_From_Date);
